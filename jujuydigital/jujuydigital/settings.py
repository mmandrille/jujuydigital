"""
Django settings for jujuydigital project.
...
SECRET_KEY = 'wf^0ya06d(l)5p#11q56$pp8zejq+63r3&i*%*+6)1mq_od$#='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'ws.jujuydigital.com.ar']
...
ROOT_URLCONF = 'jujuydigital.urls'
...
WSGI_APPLICATION = 'jujuydigital.wsgi.application'
